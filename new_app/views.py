...
def loginPage(request):
    ...
    return render(request, 'new_app/login_register.html', context)
...
def registerPage(request):
    ...
    return render(request, 'new_app/login_register.html', {'form': form}) 
...
def createRoom(request):
    ...
    return render(request, 'new_app/room_form.html', context)
...
def deleteMessage(request,pk ):
    ...
    return render (request, 'new_app/delete.html', {'obj': message} )